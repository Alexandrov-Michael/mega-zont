...
MEDIA_ROOT = os.path.abspath(os.path.join(PROJECT_PATH, '../../public_html/media/'))
...
SECRET_KEY = ')jef0%w7dhei3=zl3&amp;xb51i$7*g8-3u!=f$bn3sq$)1-ngf&amp;m('
...
template_dir = os.path.abspath(os.path.join(PROJECT_PATH, 'templates'))
TEMPLATE_DIRS = (
    template_dir,
)
